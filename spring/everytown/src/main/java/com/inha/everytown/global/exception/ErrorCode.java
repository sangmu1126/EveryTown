...
public enum ErrorCode {
    ...
    BOARD_NO_SUCH_BOARD(HttpStatus.BAD_REQUEST, "BOARD_001", "해당 게시글이 존재하지 않습니다."),

    BOARD_CATE_NO_SUCH_BOARD_CATE(HttpStatus.BAD_REQUEST, "BOARD_002", "해당 게시판이 존재하지 않습니다."),

    COMMENT_NO_SUCH_COMMENT(HttpStatus.BAD_REQUEST, "COMMETN_001", "해당 댓글이 존재하지 않습니다.")
    ;
